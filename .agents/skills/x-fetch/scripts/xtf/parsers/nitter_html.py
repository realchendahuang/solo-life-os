...
from the original nitter_client.py.

# local patch (X-Tiller): the upstream note claimed these parsers were
# "locked by fixture tests"; tests/fixtures/ does not exist in this checkout.
# Any real coverage must come from synthetic in-repo HTML strings.
"""
